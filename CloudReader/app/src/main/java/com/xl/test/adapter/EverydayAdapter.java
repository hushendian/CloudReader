...
import com.xl.test.databinding.ItemEverydayOneBinding;
import com.xl.test.databinding.ItemEverydayThreeBinding;
import com.xl.test.databinding.ItemEverydayTitleBinding;
import com.xl.test.databinding.ItemEverydayTwoBinding;
...
public class EverydayAdapter extends BaseRecyclerViewAdapter<List<AndroidBean>> {
    ...
    public int getItemViewType(int position) {
        Log.d("EverydayAdapter", "getItemViewType: "+getData().get(position).size());
    ...
    private class TitleHolder extends BaseRecyclerViewHolder<List<AndroidBean>,
            ItemEverydayTitleBinding> {
        ...
        public void onBindViewHolder(List<AndroidBean> object, int position) {
            ...
            if ("Android".equals(title)) {
                binding.ivTitleType.setImageDrawable(CommonUtils.getDrawable(R.drawable
                        .home_title_android));
                index = 0;
            ...
            binding.llTitleMore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    RxBus.getInstance().send(RxCodeConstants.JUMP_TYPE, finalIndex);
                }
            });
        }
    }
...
//                ImgLoadUtil.displayEspImage(object.get(0).getUrl(), binding.ivOnePhoto, 1);
                ImageUtils.getInstance().loadImageview(object
                                .get(0).getUrl(), R.drawable.img_two_bi_one, R.drawable
                                .img_two_bi_one,
                        binding.ivOnePhoto);
            } else {
    ...
    private class TwoHolder extends BaseRecyclerViewHolder<List<AndroidBean>,
            ItemEverydayTwoBinding> {
        ...
        @Override
        public void onBindViewHolder(List<AndroidBean> object, int position) {
            Log.d("EverydayAdapter", "onBindViewHolder: " + object.get(0).getImage_url()+"-----"+object.get(1).getImage_url());
    ...
    private class ThreeHolder extends BaseRecyclerViewHolder<List<AndroidBean>,
            ItemEverydayThreeBinding> {
    ...
    private void displayRandomImg(int imgNumber, int position, ImageView imageView,
                                  List<AndroidBean> object) {

        ImageUtils.getInstance().displayRandom(imgNumber, object.get(position).getImage_url(),
                imageView);
    }
    ...
    private void setOnClick(final LinearLayout linearLayout, final AndroidBean bean) {
        linearLayout.setOnClickListener(new PerfectClickListener() {
            ...
            protected void onNoDoubleClick(View v) {
                Log.d("EverydayAdapter", "onNoDoubleClick: ");
                WebViewActivity.loadUrl(v.getContext(), bean.getUrl(), "正在加载...");
            }
        });
        ...
        linearLayout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                String title = TextUtils.isEmpty(bean.getType()) ? bean.getDesc() : bean.getType
                        () + "：  " + bean.getDesc();
